function eventListeners(){document.querySelector(".bmenu").addEventListener("click",responsiveNavigation)}function responsiveNavigation(){document.querySelector(".nav").classList.toggle("show")}function darkmode(){const e=window.matchMedia("prefers-color-scheme: dark");e.matches?document.body.classList.add("dark-mode"):document.body.classList.remove("dark-mode"),e.addEventListener("change",(function(){e.matches?document.body.classList.add("dark-mode"):document.body.classList.remove("dark-mode")}));document.querySelector(".btnDarkmode").addEventListener("click",(function(){document.body.classList.toggle("dark-mode")}))}
